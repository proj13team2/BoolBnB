        ...
        <div class="col-12 appartamento pb-5" data-lat='{{$apartment->address->lat}}' data-lng='{{$apartment->address->lng}}' data-endaddress="{{$apartment->address->zip_code}}, {{$apartment->address->country}}">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-5 mb-3">
              <div class="green-background  text-white  text-center form-message-touser">
                @if($active == 0 || $active = '')
                    <a class="btn btn-small btn-info lightgreen-back  green-text"  href="{{ route('user.apartment.sponsorization', ['apartment' => $apartment->id]) }} ">  Sponsorizza </a>
                @else
                ...
                @endif
                <div class="pt-3">
                    <a class="btn btn-small btn-info lightgreen-back  green-text"  href="{{ route('user.apartments.edit', ['apartment' => $apartment->id]) }}">  Edit </a>
                </div>
                <div class="pt-3">
                  <a class="btn btn-small btn-info lightgreen-back green-text"  href="{{ route('user.apartments.index') }}">  Dashboard </a>
                </div>
              </div>
            </div>
